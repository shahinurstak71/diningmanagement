...
class AllMealPost extends StatefulWidget {
  AllMealPost({Key? key}) : super(key: key);

  @override
  State<AllMealPost> createState() => _AllMealPostState();
}

class _AllMealPostState extends State<AllMealPost> {
  ...
  final Stream<QuerySnapshot> _usersStream = FirebaseFirestore.instance.collection('AllTime').snapshots();

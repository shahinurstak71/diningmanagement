...
class LunchMealPost extends StatefulWidget {
  LunchMealPost({Key? key}) : super(key: key);

  @override
  State<LunchMealPost> createState() => _LunchMealPostState();
}

class _LunchMealPostState extends State<LunchMealPost> {
  ...
  final Stream<QuerySnapshot> _usersStream = FirebaseFirestore.instance.collection('Lunch').snapshots();
